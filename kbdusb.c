...
int mapkey(const unsigned char keypressed) {
  ...
  switch (keypressed) {
    ...
    case 0x2e:
      ...
      break;
    case 0x2a:
      keysent = KEY_BACKSPACE;
      break;
    case 0x2b:
      keysent = KEY_TAB;
      break;
    case 0x2f:
      keysent = KEY_LEFTBRACE;
      break;
    case 0x30:
      keysent = KEY_RIGHTBRACE;
      break;
    case 0x28:
      keysent = KEY_ENTER;
      break;
    case 0x33:
      keysent = KEY_SEMICOLON;
      break;
    case 0x34:
      keysent = KEY_APOSTROPHE;
      break;
    case 0x35:
      keysent = KEY_GRAVE;
      break;
    ...
    case 0x38:
      ...
      break;
    case 0x55:
      keysent = KEY_KPASTERISK;
      break;
    case 0x2c:
      keysent = KEY_SPACE;
      break;
    case 0x39:
      keysent = KEY_CAPSLOCK;
      break;
    case 0x3a:
      keysent = KEY_F1;
      break;
  ...
  while (fgets(buffer, 79, in)) {
    ...
    if (ibytes_reported == 9) { /* a regular key, 8 bytes + 0x71 */
      ...
      for (int i = 2; i < ibytes_reported * 2; i += 2) {
        ...
        c2[1] = 0;
        keypressed[i / 2 - 1] =
            (unsigned char)strtol(c1, NULL, 16) * 16 + strtol(c2, NULL, 16);
        if (DEBUG)
      ...
      /* special keys */
      if (DEBUG)
        printf("keypressed_prec[0]=%i  keypressed[0]=%i\n", keypressed_prec[0],
               keypressed[0]);
      if (DEBUG)
        printf("bit 5 is set in keypressed[0] = %i\n",
